...
\geometry{left=2cm, top=1.5cm, right=2cm, bottom=1.5cm} % Configure page margins with geometry
...
\address{
\smallskip
115 Ridgewood Ave, Farmingville, New York 11738
}
...
\linkedin{https://linkedin.com/in/xizhangsbu}
%\skype{skypeid}
