...
\geometry{left=2cm, top=2cm, right=2cm, bottom=2cm} % Configure page margins with geometry
...
\address{
\smallskip
2087 Mahuron Cir, San Jose, CA 95133
}
%\address{
%\smallskip
%115 Ridgewood Ave, Farmingville, NY 11738
%}

\mobile{631-759-1966}
%\email{xi.zhang.1@stonybrook.edu}
\email{xizhang1@cs.stonybrook.edu}
\homepage{xizhang77.github.io/}
%\github{github.com/xizhang77}
\linkedin{www.linkedin.com/in/xizhangsbu}
%\skype{skypeid}
...
% \input{cv-sections/projects-swe.tex}
\input{cv-sections/projects-ml.tex}
